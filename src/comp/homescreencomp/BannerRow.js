...
let itemLaptop = [
  {
    title: 'Item 1',
    uri: server2 + '/BannerImages/laptop/Banner 4.png',
  },
  {
    title: 'Item 2',
    uri: server2 + '/BannerImages/laptop/Banner 3.png',
  },
  {
    title: 'Item 3',
    uri: server2 + '/BannerImages/laptop/Banner 2.png',
  },
  {
    title: 'Item 4',
    uri: server2 + '/BannerImages/laptop/Banner 1.png',
  },
];
...
let itemMobile = [
  {
    title: 'Item 1',
    uri: server2 + '/BannerImages/mobile/Banner 4.png',
  },
  {
    title: 'Item 2',
    uri: server2 + '/BannerImages/mobile/Banner 3.png',
  },
  {
    title: 'Item 3',
    uri: server2 + '/BannerImages/mobile/Banner 2.png',
  },
  {
    title: 'Item 4',
    uri: server2 + '/BannerImages/mobile/Banner 1.png',
  },
];
